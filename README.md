...
- `copy-vault.html`: 160+ pastable copy blocks across fourteen sections (bios, every premade and custom listing, launch and evergreen posts, positioning, customer messages, the voice card, etsy editor settings) plus the asset cheat sheet, every block has its own copy button.
- `listing-pack.html` / `listing-images/`: every etsy listing image, 2000x2000, for all seven premade kits in both lanes plus the twelve custom boards and video, with per-lane zips and 400px thumbs; `listing-pack/` keeps the original seven-photo pack and the "why hello paint" card.
