...
- `copy-vault.html`: forty-eight pastable copy blocks (bios, the Etsy listing, launch posts, anytime posts, the positioning section, customer message templates, the voice card) plus the asset cheat sheet, every block has its own copy button.
- `listing-pack.html` / `listing-pack/`: seven etsy-ready listing photos (2000×2000 JPEG) built from real kit pages, plus a bonus 8th "why hello paint" card that puts the free-generators / hello-paint / mailed-kits comparison straight into an image, for pinterest or a caption card since all ten etsy photo slots are already spoken for.
